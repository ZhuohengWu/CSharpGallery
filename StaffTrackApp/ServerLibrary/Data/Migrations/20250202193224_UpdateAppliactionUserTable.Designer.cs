...
{
    [DbContext(typeof(StaffTrackDb))]
    [Migration("20250202193224_UpdateAppliactionUserTable")]
    partial class UpdateAppliactionUserTable
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("BaseLibrary.Entities.Doctor", b =>
                {
                    ...
                    b.Property<string>("Recommondation")
                        .IsRequired()
                        .HasColumnType("nvarchar(max)");
